        ...
        <form class="space-y-6" @submit.prevent="submit">
          ...
          <div class="space-y-2">
            ...
            <div class="relative group">
              ...
              <input class="block w-full pl-10 pr-3 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all sm:text-sm" type="text" v-model="username"/>
            </div>
          </div>
          <!-- Password Field -->
          <div class="space-y-2">
            ...
            <div class="relative group">
              ...
              <input class="block w-full pl-10 pr-10 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all sm:text-sm" :type="showPassword ? 'text' : 'password'" v-model="password"/>
