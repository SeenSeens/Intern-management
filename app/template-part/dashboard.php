<div class="wrap">
    ...
    <div style="display: flex; gap: 20px; margin-top: 20px;">
        <?php
        $cards = [
            ['label' => 'Sinh viên', 'value' => 25, 'color' => '#3498db'],
            ['label' => 'Dự án', 'value' => 10, 'color' => '#2ecc71'],
            ['label' => 'Nhiệm vụ', 'value' => 58, 'color' => '#f1c40f'],
    ...
    <div style="margin-top: 40px;">
        ...
        <table class="wp-list-table widefat fixed striped">
            ...
            <tr>
                ...
                <td>Nguyễn Văn A</td>
                <td>18/07/2025</td>
                <td><span style="color: orange;">Đang làm</span></td>
            </tr>
            <tr>
                ...
                <td>Trần Thị B</td>
                <td>20/07/2025</td>
                <td><span style="color: red;">Chưa làm</span></td>
            </tr>
            <!-- Thêm nhiều dòng tùy ý -->
            </tbody>
        </table>
    </div>
</div>
