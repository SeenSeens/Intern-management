...
class ProjectMentorController extends Controller{
    ...
    public function store(){
        ...
        if ($mentor_ids  ) :
            $this->projectMentorAction->update_mentor($project_id, $mentor_ids, get_current_user_id());
        endif;
        $this->projectMentorAction->assign_mentor($project_id, $mentor_ids, get_current_user_id());
